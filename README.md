...
- 首页瀑布流：重构项目首页为双列不等高瀑布流，支持科研日报图文卡片、封面自适应、圆角阴影、标签露出、骨架屏、空状态、分类筛选、标签筛选和上拉加载更多。
- 日报创作发布：新增科研日报创作页，支持标题、摘要、正文、封面图、图文混排图片、文字排版工具、实时预览、草稿保存、即时发布、内容编辑和内容删除。
- 科研模板：内置实验记录、文献阅读、科研总结三类模板，可一键填充正文结构，覆盖科研日报高频创作场景。
- 话题标签：新增科研话题广场和话题详情页，支持自定义添加科研标签、学科分类、研究方向分类，并可按标签聚合展示对应日报内容。
- 后端接口：FastAPI 新增日报表、话题分类表、科研标签表和日报标签关联表，覆盖日报分页/详情/模板/创建/更新/发布/删除、图片上传、分类 CRUD、标签 CRUD、筛选查询和话题聚合接口。
